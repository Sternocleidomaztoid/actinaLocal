...
const atlasImages = require.context('./../../../../src/assets/img/atlas', true);
                    ...
                    <div className="flashcard bgWhite">
                        ...
                        {filteredAtlas.length > 0 && currentPageIndex < filteredAtlas[0].pages.length && (
                            <div key={currentPageIndex}>
                                ...
                                <ul>
                                    <li className='atlasImageContainer'><img src={atlasImages(`./${filteredAtlas[0].pages[currentPageIndex]?.image}`)} alt={filteredAtlas[0].pages[currentPageIndex]?.topic} /></li>
